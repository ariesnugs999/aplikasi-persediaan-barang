    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="assets/img/khz1.png" alt="Logo"> 
          <span style="font-size:30px">Warehouse</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2018 - <a href="www.khanza.com">www.khanza.com</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
